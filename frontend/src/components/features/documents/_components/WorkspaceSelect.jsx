...
export const WorkspaceSelect = ({
	...
	if (loading) return <div className='text-neutral-400'>Loading Workspaces</div>;
	if (error) {
	...
	return (
		...
		>
			<SelectTrigger className={
				(fullWidth ? 'w-full' : 'w-[200px]') + ' bg-neutral-900 text-neutral-100 border border-neutral-700 placeholder:text-neutral-500 focus:ring-0 outline-none rounded-md transition-colors duration-150'
			}>
