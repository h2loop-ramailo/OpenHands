...
export enum I18nKey {
  ...
  HOME$H2LOOP_DESCRIPTION = "HOME$H2LOOP_DESCRIPTION",
  ...
  BRANDING$H2LOOP_AI = "BRANDING$H2LOOP_AI",
  BRANDING$H2LOOP_LOGO = "BRANDING$H2LOOP_LOGO",
  ...
  CONFIGURATION$H2LOOP_WORKSPACE_DIRECTORY_INPUT_LABEL = "CONFIGURATION$H2LOOP_WORKSPACE_DIRECTORY_INPUT_LABEL",
  ...
  LLM$MODEL = "LLM$MODEL",
  CONFIGURATION$H2LOOP_WORKSPACE_DIRECTORY_INPUT_PLACEHOLDER = "CONFIGURATION$H2LOOP_WORKSPACE_DIRECTORY_INPUT_PLACEHOLDER",
  ...
  SIDEBAR$DOCUMENTS = "SIDEBAR$DOCUMENTS",
  ...
  SYSTEM_MESSAGE_MODAL$H2LOOP_VERSION = "SYSTEM_MESSAGE_MODAL$H2LOOP_VERSION",
